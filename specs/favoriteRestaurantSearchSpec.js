import FavoriteRestaurantSearchPresenter from '../src/scripts/views/pages/likes/favorite-restaurant-search-presenter';
...
describe('Searching restaurant', () => {
        ...
        describe('When query is empty', () => {
                ...
                it('should show all favorite restaurants', () => {
                        searchRestaurants('    ');
                        expect(favoriteRestaurants.FavoriteRestaurantIdb)
                                .toHaveBeenCalled();
                });
        });
